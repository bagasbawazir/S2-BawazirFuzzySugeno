...
<div class="w-full my-3 dark:bg-slate-800">
    <div x-data={show:true} class="rounded-full">
        <div class="px-4 py-3 rounded-t-md cursor-pointer bg-slate-100 border border-slate-200 dark:border-slate-600 dark:bg-slate-600" @click="show=!show">
        ...
        <div x-show="show" class="border-l rounded-b-md border-b border-r border-slate-200 dark:border-slate-600 px-2 py-4 dark:border-0 dark:bg-slate-700">
            <div>
                @php
                    $customConfig = [];
                @endphp
