        ...
        <div @class([
            ...
            <div @class([
                ...
                <div @class([
                    ...
                    <div class="relative">
                        <select class="power_grid {{ $theme->selectClass }} {{ data_get($column, 'headerClass') }}" style="{{ data_get($column, 'headerStyle') }}" wire:model.lazy="filters.input_text_options.{{ $field }}" wire:input.lazy="filterInputTextOptions('{{ $field }}', $event.target.value, '{{ data_get($inputText, 'label') }}')">
